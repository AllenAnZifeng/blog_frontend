...
export function Header() {
    ...
    const submitHandler = (event:SyntheticEvent,email:string,pwd:string) => {
        ...
        if (panel==='Register'){
            const fetchData = async () => {
                ...
                let rawResponse = await fetch(ip_addr+"/api/register", {
                    method: 'POST',
                    headers: {
            ...
            const fetchData = async () => {
                ...
                let rawResponse = await fetch(ip_addr+"/api/login", {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
    ...
    return <><div className={'header'}>
                <div className={'headerContent'}>
                    <div className={'title'}><a href={"https://zifengallen.me/"}><img className={'an'} src={"../../an.png"} alt={'安'}/></a><Link to={"/"}>Zifeng's Blog</Link></div>
